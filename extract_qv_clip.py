...
for layer in tqdm(range(num_layers)):
    for head in range(num_heads):
        ...
        for i in range(len(llava_embeddeds["PCA"][layer][head])):
            token_data = {
                "tsne_x": round(float(llava_embeddeds["TSNE"][layer][head][i, 0]), 3),
                "tsne_y": round(float(llava_embeddeds["TSNE"][layer][head][i, 1]), 3),
                "tsne_x_3d": round(float(llava_embeddeds["TSNE_3d"][layer][head][i, 0]), 3),
                "tsne_y_3d": round(float(llava_embeddeds["TSNE_3d"][layer][head][i, 1]), 3),
                "tsne_z_3d": round(float(llava_embeddeds["TSNE_3d"][layer][head][i, 2]), 3),
                ...
                "umap_x": round(float(llava_embeddeds["UMAP"][layer][head][i, 0]), 3),
                "umap_y": round(float(llava_embeddeds["UMAP"][layer][head][i, 1]), 3),
                "umap_x_3d": round(float(llava_embeddeds["UMAP_3d"][layer][head][i, 0]), 3),
                "umap_y_3d": round(float(llava_embeddeds["UMAP_3d"][layer][head][i, 1]), 3),
                "umap_z_3d": round(float(llava_embeddeds["UMAP_3d"][layer][head][i, 2]), 3)
            }
