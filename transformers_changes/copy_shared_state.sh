...
# Copy shared_state.py from the current directory (where this script is) to the destination
cp shared_state.py "$DEST_DIR/"

echo "shared_state.py has been copied to: $DEST_DIR"
